...
PO_and_Sch<-read.csv("C:\\Users\\shruti.shahi\\Desktop\\BGM\\Analytics\\Sch&PO\\Total_SCH_PO\\FWD_Deep_Zone_Data_V2 2024-07-29 .csv",header = T)
...
############ IWIT Calculation
IWIT<-read.csv("C:\\Users\\shruti.shahi\\Desktop\\BGM\\Analytics\\IWIT\\IWIT_Monthly_FSN 2024-07-29 .csv",header = T)
...
write.csv(repeated_df_summary_national,"C:\\Users\\shruti.shahi\\Desktop\\BGM\\Analytics\\Output\\MSTN_29Jul_national_v1.csv",row.names = FALSE)
...
write.csv(repeated_df_summary_zone,"C:\\Users\\shruti.shahi\\Desktop\\BGM\\Analytics\\Output\\MSTN_29Jul_zonal_v1.csv",row.names = FALSE)
...
write.csv(repeated_df_summary_cluster,"C:\\Users\\shruti.shahi\\Desktop\\BGM\\Analytics\\Output\\MSTN_29Jul_cluster_v1.csv",row.names = FALSE)
