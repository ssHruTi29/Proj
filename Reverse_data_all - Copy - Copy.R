...
Space_Avl = data.table(read_sheet('https://docs.google.com/spreadsheets/d/1Ghu4rYp3lWo7J1zrrI4C9t0h2h-5jhsFOLN5lJF_6wc/edit?gid=0#gid=0'))
...
atp_details_summary[,row_count:=.N,by=c("fc","space_Flag")]
